...
class RootStore {
  ...
  RedeemCode = flow(function * (email, Token, name) {
    try {
      ...
      this.email = email;
      this.name = name;
      this.chatClient = new StreamChat('vwju6nnu5dmh');
  ...
  CreateCharge = flow(function * (name, description) {
    try {
      ...
      var newCharge = new Charge({
        ...
        "redirect_url": "https://core.test.contentfabric.io/prod/site-sample-live-fox/#/success",
        "cancel_url": "https://core.test.contentfabric.io/prod/site-sample-live-fox/#/"
      });
